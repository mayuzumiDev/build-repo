...
const axiosInstance = axios.create({
  baseURL: "http://31.170.165.140/", // Set the base URL for all requests
  withCredentials: true,
});

const axiosInstanceNoAuthHeader = axios.create({
  baseURL: "http://31.170.165.140/", // Set the base URL for all request without authorization header
  withCredentials: true,
});
